      ...
      <div className="relative bg-white rounded-lg shadow-xl p-4 sm:p-8 w-full max-w-4xl m-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              type="text"
              className="w-full form-input border border-gray-300 rounded-lg shadow-sm p-2 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 text-black caret-black bg-white"
          ...
          <div>
            ...
            <textarea
              className="w-full form-textarea border border-gray-300 rounded-lg shadow-sm p-2 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 text-black caret-black bg-white"
