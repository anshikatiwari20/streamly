    ...
    <div>
      {tags?.length > 0 && (
        <div className="flex items-center gap-2 flex-wrap mt-2">
          {tags.map((tag, index) => (
            <span
              key={index}
              className="flex items-center text-black bg-white shadow px-3 py-1 rounded-full text-xs mr-1 border border-gray-300">
              #{tag}
      ...
      <div className="flex items-center gap-4 mt-3">
        <input
          ...
          type="text"
          className="flex-grow border px-3 py-2 rounded outline-none text-black caret-black bg-white"
